...
{
    public partial class frmDepositoI : Form
    {
        public frmDepositoI()
        {
            InitializeComponent();
        ...
        {           
            using (var hb = new DBdatos2())
            {
                ...
                frmDepositoA.MostrarDatos(I02, DS, DSFiltros, "I", dgvLeyenda, ListaProductos, ref CantidadOcupados, ref FiltroActivo, ProductoDescripcion,ProductoCantidad,ColorProducto,chart1);
                frmDepositoA.MostrarDatos(I03, DS, DSFiltros, "I", dgvLeyenda, ListaProductos, ref CantidadOcupados, ref FiltroActivo, ProductoDescripcion,ProductoCantidad,ColorProducto,chart1);
                frmDepositoA.MostrarDatos(I04, DS, DSFiltros, "I", dgvLeyenda, ListaProductos, ref CantidadOcupados, ref FiltroActivo, ProductoDescripcion,ProductoCantidad,ColorProducto,chart1);
                frmDepositoA.MostrarDatos(I05, DS, DSFiltros, "I", dgvLeyenda, ListaProductos, ref CantidadOcupados, ref FiltroActivo, ProductoDescripcion,ProductoCantidad,ColorProducto,chart1);
                frmDepositoA.MostrarDatos(I06, DS, DSFiltros, "I", dgvLeyenda, ListaProductos, ref CantidadOcupados, ref FiltroActivo, ProductoDescripcion,ProductoCantidad,ColorProducto,chart1);
                frmDepositoA.MostrarDatos(I07, DS, DSFiltros, "I", dgvLeyenda, ListaProductos, ref CantidadOcupados, ref FiltroActivo, ProductoDescripcion,ProductoCantidad,ColorProducto,chart1);
                frmDepositoA.MostrarDatos(I08, DS, DSFiltros, "I", dgvLeyenda, ListaProductos, ref CantidadOcupados, ref FiltroActivo, ProductoDescripcion,ProductoCantidad,ColorProducto,chart1);
                frmDepositoA.MostrarDatos(I09, DS, DSFiltros, "I", dgvLeyenda, ListaProductos, ref CantidadOcupados, ref FiltroActivo, ProductoDescripcion,ProductoCantidad,ColorProducto,chart1);
                frmDepositoA.MostrarDatos(I10, DS, DSFiltros, "I", dgvLeyenda, ListaProductos, ref CantidadOcupados, ref FiltroActivo, ProductoDescripcion,ProductoCantidad,ColorProducto,chart1);
                frmDepositoA.MostrarDatos(I11, DS, DSFiltros, "I", dgvLeyenda, ListaProductos, ref CantidadOcupados, ref FiltroActivo, ProductoDescripcion,ProductoCantidad,ColorProducto,chart1);
                frmDepositoA.MostrarDatos(I12, DS, DSFiltros, "I", dgvLeyenda, ListaProductos, ref CantidadOcupados, ref FiltroActivo, ProductoDescripcion,ProductoCantidad,ColorProducto,chart1);
                frmDepositoA.MostrarDatos(I13, DS, DSFiltros, "I", dgvLeyenda, ListaProductos, ref CantidadOcupados, ref FiltroActivo, ProductoDescripcion, ProductoCantidad, ColorProducto, chart1);
        ...
        private void frmDepositoI_KeyDown(object sender, KeyEventArgs e)
        {

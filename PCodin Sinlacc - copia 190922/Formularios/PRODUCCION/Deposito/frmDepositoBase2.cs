...
{
    public partial class frmDepositoBase2 : Form
    {
        public frmDepositoBase2()
        {
            InitializeComponent();
        }
        public string Accion;
        public frmAgregarProdcutoTerminado FormularioAgregar;
        public frmDepositoBase FormularioDeposito;
        private void frmDepositoBase2_Load(object sender, EventArgs e)
        {
            IniciabilizarForm();
        }

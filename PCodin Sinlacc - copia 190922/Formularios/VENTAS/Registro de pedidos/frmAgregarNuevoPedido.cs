...
namespace PCodin_Sinlacc.Formularios
{
    public partial class frmAgregarNuevoPedido : Form
    {
        ...
        private void InicializarForm()
        {
            ...
            if (PulsoAgregarEditar == "2")
            {
                ...
                using (var hb = new DBdatos())
                {
                    ...
                    var ConsultaVP = (from VP in hb.VistaPedidos002
                                      where VP.PedidoID == IdRecibido
        ...
        private void txtFiltraBuscaProducto_Click(object sender, EventArgs e)
        {
            var txtSeleccionado = sender as TextBox;
            Reutilizables.Teclado(txtSeleccionado);
        }

...
{
    public partial class frmAgregarNuevoPedidoMOB : Form
    {
        ...
        public frmAgregarNuevoPedidoMOB()
        {
            InitializeComponent();
        }
        ...
        private void InicializarForm()
        {
            ...
            btnGeneral.BackColor = Color.Orange;
            ...
            if (dgvPedidoProductos.RowCount > 0)
            {
                if (this.dgvPedidoProductos.Columns[e.ColumnIndex].Name == "colEstado")
                {
                    if (e.Value.ToString() == "Completo")
                    {
                        ...
                        e.CellStyle.Font = new Font("Roboto Condensed", 16, FontStyle.Bold);
                    }
                    else
                    {
        ...
        private void txtCantidad_Click(object sender, EventArgs e)
        {
            ...
            TecladoNumerico(txtSeleccionado);
        ...
        private void pnlSuperior3_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void btnGeneral_Click(object sender, EventArgs e)
        {
            ...
            btnProductos.BackColor = Color.WhiteSmoke;
            btnGeneral.BackColor = Color.Orange;
            pnlSuperior2.Dock = DockStyle.Fill;
        ...
        private void TecladoNumerico(TextBox txtSeleccionado)
        {
            var f = new frmTecladoNumerico();
            f.txtSeleccionado = txtSeleccionado;
            f.txtResultado.Text = txtSeleccionado.Text;
            f.ShowDialog();
        }
